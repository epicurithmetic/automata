...
ani = animation.ArtistAnimation(fig, image, interval = 100, blit=True,
                                repeat_delay=0)
ani.save(("CA_Rule%s.mp4" % rule), writer='ffmpeg', fps=20)

print 'Image of Wolf code %s is complete.' % rule
