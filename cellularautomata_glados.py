...
print 'Hi. I am GLaDOS, your personal cellular automata bot.'
print 'I am here to help you experiment with one dimensional cellular automata.\n'

print 'Please enter the Wolfram code you would like to use for this run of the'
print 'cellular automata code. Recall these are integers in [0,255].'
rule = raw_input('')
print 'Thank you.'
print 'This script will evolve an initial condition according to Wolfram Code %s' % rule
print 'for one-dimensional cellular automata.\n'
# print 'Please press "Enter" to execute the code. Remember to look for'
# print 'cake in the picture below.'
# cont = raw_input()
print '\n'
...
print '\nNow that you know how the automata will change the state.'
print 'You need to enter an initial state to start with'
print 'Please enter a binary string of digits:'
...
print '\nThank you. I will now input your initial state'
print "and iterate it with Rule %s of Wolfram's code" % rule
print '\n'
...
for state in sierpinski_printable:
    print state
print '\nHere is the diagram. Did you see the cake? (Y/n)'
answer = raw_input('')
if answer == 'Y':
    if rule == '90':
        print 'So much Sierpinski cake. How many slices are there?'
        print 'See. I told you there would be cake.'
        print 'I hope you trust me...'
    else:
        print 'Liar! I did not put any cake into the picture.'
        print 'We will get along much better if you tell me the truth... \n'
else:
    os.system("cls")
    print 'Ohwell, there will definitely be cake next time.'
